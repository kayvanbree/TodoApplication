...
export class SomeComponentComponent implements OnInit, OnDestroy, AfterViewInit, AfterViewChecked, DoCheck, OnChanges, AfterContentInit, AfterContentChecked {

  @Input() somethingElse: boolean;
